...
)  # (signmob/config/settings/base.py - 3 = signmob/)
APPS_DIR = ROOT_DIR.path("signmob")
...
LOCAL_APPS = [
    "signmob.users.apps.UsersConfig",
    "signmob.collection.apps.CollectionConfig",
...
MIGRATION_MODULES = {"sites": "signmob.contrib.sites.migrations"}
...
ADMINS = [("""Stefan Wehrmeyer""", "stefan.wehrmeyer@okfn.de")]
